...
if(isset($_REQUEST['priceid'])){
	if(is_array($_REQUEST['priceid'])){
        $priceid = ( isset( $_REQUEST['priceid'][0] ) && is_array( $_REQUEST['priceid'] ) ) ? sanitize_text_field( wp_unslash( $_REQUEST['priceid'][0] ) ) : '';
	} else {
        $priceid = isset( $_REQUEST['priceid'] ) ? sanitize_text_field( wp_unslash( $_REQUEST['priceid'] ) ) : '';
	}
}
