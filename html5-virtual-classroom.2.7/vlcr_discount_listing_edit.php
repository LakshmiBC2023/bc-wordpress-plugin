...
$class_data = (object)$vc_obj->vlcr_class_detail($cid);
...
if(isset($_REQUEST['discountid'])){
    ...
    $discountid = ( isset( $_REQUEST['discountid'][0] ) && is_array( $_REQUEST['discountid'] ) ) ? sanitize_text_field( wp_unslash( $_REQUEST['discountid'][0] ) ) : '';
	} else {
    $discountid = isset( $_REQUEST['discountid'] ) ? sanitize_text_field( wp_unslash( $_REQUEST['discountid'] ) ) : '';
	}
 }
